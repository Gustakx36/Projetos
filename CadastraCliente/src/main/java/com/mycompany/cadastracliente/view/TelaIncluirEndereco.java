 ...
 * @author Gu5t4_B
 */
public class TelaIncluirEndereco extends javax.swing.JFrame {
    ...
    public void inseriInformacaoEndereco(){
        ...
        inseriEndereco.setLogin(clienteBanco.pesquisaPorId(txtCpf.getText()));
        inseriEndereco.setAtivo(true);
        inseriEndereco.setRegistro(txtCpf.getText());
