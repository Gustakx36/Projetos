...
public class Cliente {
    ...
    public Cliente(String nome, String cpf, String rg, String email, String telefone1, String telefone2, Date dataNascimentoInserir, String dataNascimento , Boolean ativo, int login) {
        this.nome = nome;
        this.cpf = cpf;
        this.rg = rg;
        this.email = email;
