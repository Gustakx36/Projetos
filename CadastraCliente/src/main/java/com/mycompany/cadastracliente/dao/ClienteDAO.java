...
public class ClienteDAO {
    ...
    public void inseriCliente(Cliente nome) {
        ...
        try ( PreparedStatement queryAddCliente = this.conn
            ...
            queryAddCliente.setString(8, nome.getLogin());
    ...
    public ArrayList<Cliente> pesquisaTodosClientesPorLogin(String login){
        ...
        try ( PreparedStatement queryPesquisaCliente = this.conn
            ...
            queryPesquisaCliente.setString(1, login);
    ...
    public Integer pesquisaPorUltimoId(){
    ...
    public ArrayList<Cliente> pesquisaTodosClientesPorLoginAdm(String login){
